    ...
    <div class="main-panel">
        <div class="container">
            <div class="page-inner">
                <div class="page-header"><h4 class="page-title">마이페이지 - 승인관리</h4></div>
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4 col-lg-4 mb-5">
                                <div class="main-info" data-toggle="modal" data-target="#approveModal" style="cursor: pointer">
                                    <table>
                                        <tr>
                                            <th>프로젝트명</th>
                                            <td>oo은행 유지보수</td>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">프로젝트 승인관리</h4>
                ...
                <div class="manpower mb-3">
                    <table class="scrolltable scrolltable2">
                        ...
                        <tr>
                            ...
                            <td>22-08-01</td>
                            <td>
                                <button class="btn btn-round mr-1 btn-green"><i class="fas fa-check"></i></button>
                                <button class="btn btn-round btn-red"><i class="fa fa-times"></i></button>
                            </td>
                        </tr>
                        <tr>
                            <td>임꺽정</td>
