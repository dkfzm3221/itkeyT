...
<div class="wrapper wrapper-login">
    ...
    <div class="container container-findidtrue animated fadeIn" style="display: none">
        ...
        <div class="login-form">
            ...
            <div class="form-action">
                <a href="#" id="findPw" class="p-0 btn btn-link btn-black show-back">비밀번호 찾기</a>
            </div>
        </div>
    </div>
    ...
    <div class="container container-findpw animated fadeIn" style="display: none">
        ...
        <p class="text-center mb-4">아이디와 담당자 이메일을 입력해주세요.<br>임시 비밀번호는 담당자 이메일로 전송됩니다.</p>
        <div class="login-form">
            <div class="form-group form-floating-label">
                <input id="tempId" name="cacId" type="text" class="form-control input-border-bottom" required>
                <label for="tempId" class="placeholder">아이디</label>
            </div>

            <div class="form-group form-floating-label">
                <input id="tempCustMngEmail" name="custMngEmail" type="text" class="form-control input-border-bottom" required>
                <label for="tempCustMngEmail" class="placeholder">담당자 이메일</label>
            </div>
    ...
    <div class="container container-signup animated fadeIn" style="padding: 40px 25px;">
        ...
        <form id="memberJoinForm" method="post" action="">
            <div class="login-form">
                ...
                <div class="h-110">
                    <div class="form-group">
                        <label for="joinCacPwChk" class="placeholder">휴대폰 번호</label>
                        <input id="joinHP" name="hp" type="text" class="form-control">
                    </div>
                </div>
                <div class="h-110">
                    <div class="form-group">
                        <label for="joinCacPwChk" class="placeholder">이메일</label>
...
<script>
    ...
    function sendTemporaryPw() {
        ...
        var cacId = $("#tempId").val();
        var custMngEmail = $("#tempCustMngEmail").val();

        $.ajax({
            type: "POST",
            url: "findPw",
            data: {cacId: cacId, custMngEmail: custMngEmail},
            dataType: "json",
            success: function (data) {
                if (data.result === 'success') {
                    $.ajax({
                        ...
                        data: {
                            cacId: cacId,
                            receiver: custMngEmail,
                            sender: "",
                            senderNm: "YOURD",
                            receiverName: data.custNm,
                            custIdx: data.custIdx
